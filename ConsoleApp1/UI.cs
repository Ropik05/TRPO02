...
namespace ConsoleApp1
{
    static class UI
    {
        ...
        {
            Console.WriteLine($"Аудитория.НазваниеАудитории={аудитория.Название}");
            Print(аудитория.Ответственный);
            Console.WriteLine($"Аудитория.КоличествоМест={аудитория.КоличествоПосадочныхМест}");
            Console.WriteLine($"Аудитория.КоличествоОкон={аудитория.КоличествоОкон}");
            foreach (Var15Оборудование оборудование in аудитория.Оборудования)
            {
                Print(оборудование);
            }
        }
